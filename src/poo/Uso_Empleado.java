...
public class Uso_Empleado {
	...
	public static void main(String[] args) {
		...
		System.out.println(jefe_Finanzas.tomar_decision("Dar más días de vacaciones a todos" + "los empleados"));

		jefe_Finanzas.establece_bonus(5000);

		System.out.println(
				"El jefe " + jefe_Finanzas.dameNombre() + " tiene un bonus de: " + jefe_Finanzas.establece_bonus(500));

		System.out
				.println(misEmpleados[3].dameNombre() + " tiene un bonus de: " + misEmpleados[3].establece_bonus(200));
		...
		for (Empleado e : misEmpleados) {
			...
			System.out.println(
					e.dameNombre() + " Sueldo: " + e.dameSueldo() + " Fecha de Alta: " + e.dameFechaContrato());
		}
