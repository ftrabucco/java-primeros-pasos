...
public class Uso_Empleado {
	...
	public static void main(String[] args) {
		...
		System.out.println("Nombre: "+empleado1.dameNombre()+" Sueldo: "+empleado1.dameSueldo()+
				" Fecja de Alta: "+ empleado1.dameFechaContrato());
		
		System.out.println("Nombre: "+empleado2.dameNombre()+" Sueldo: "+empleado2.dameSueldo()+
				" Fecja de Alta: "+ empleado2.dameFechaContrato());
		
		System.out.println("Nombre: "+empleado3.dameNombre()+" Sueldo: "+empleado3.dameSueldo()+
				" Fecja de Alta: "+ empleado3.dameFechaContrato());*/
		...
		for(int i=0;i<3;i++) {
			...
			System.out.println("Nombre: "+misEmpleados[i].dameNombre()+" Sueldo: "+misEmpleados[i].dameSueldo()+
					" Fecja de Alta: "+ misEmpleados[i].dameFechaContrato());
		...
		for(Empleado e:misEmpleados) {
			...
			System.out.println("Nombre: "+e.dameNombre()+
					" Sueldo: "+e.dameSueldo()+
					" Fecja de Alta: "+ e.dameFechaContrato());
		}
